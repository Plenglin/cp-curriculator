...
from scraper.curriculum import lex_courselist, RawCourse, TotalUnits, AreaHeader, OrCourse, SelectFromTheFollowing, \
    Comment


def get_single_courselist(path):
...
conc_laes_cgraph, = get_single_courselist('test_resources/conc-laes-cgraph.html')
qs_minor, = get_single_courselist('test_resources/queer-studies-minor.html')
math_major, math_ge = get_single_courselist('test_resources/bs-math.html')
